...
const courseDetails = {
  ...
  instructorBio: 'Dr. Sarah Johnson is a renowned literature professor specializing in folklore and fairy tales. She holds a Ph.D. in Comparative Literature from Harvard University and has published several books on the cultural significance of fairy tales. Dr. Johnson is passionate about making literary analysis accessible to everyone and has taught over 50,000 students worldwide. Her AI-assisted teaching approach has revolutionized how students engage with classic literature.'
};
...
const allCoursesData = [
  ...
  },
  {
    ...
    courseContent: courseDetails.courseContent,
    requirements: courseDetails.requirements,
    instructorBio: 'Effy Maxwell is an AI tutor with expertise in Six Sigma methodologies and quality management. With a background in process improvement and statistical analysis, Effy provides personalized guidance to help professionals prepare for certification exams and implement Six Sigma principles in their organizations.'
  },
  {
    id: '3',
    ...
    courseContent: courseDetails.courseContent,
    requirements: courseDetails.requirements,
    instructorBio: 'Finnan Morgan is an AI tutor specializing in financial analysis and investment management. With deep knowledge of CFA exam requirements and financial markets, Finnan provides personalized guidance to help aspiring financial analysts master complex concepts and prepare for certification.'
  }
];
...
export default function CourseDetailPage({ params }: { params: { id: string } }) {
  ...
  const buyNow = () => {
    // In a real app, this would add the course to the cart and redirect to checkout
                  ...
                  <div className="flex items-center">
                    <div className="flex">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <svg 
                          key={star} 
                          className={`w-5 h-5 ${star <= Math.floor(currentCourse.rating) ? 'text-yellow-500' : 'text-gray-300'}`} 
                          fill="currentColor" 
                          viewBox="0 0 20 20"
                        >
            ...
            {activeTab === 'instructor' && (
              <div>
                ...
                <div className="flex items-start space-x-6 mb-8">
                  ...
                  <div>
                    <h3 className="text-xl font-medium mb-2">{courseDetails.instructor}</h3>
                    <p className="text-muted-foreground mb-4">Literature Professor and Folklore Specialist</p>
                ...
                <div className="prose max-w-none">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Dr. Johnson's innovative approach combines traditional literary analysis with cutting-edge AI technology to create a personalized learning experience. Her AI-assisted teaching methodology has been featured in educational journals and has proven to significantly enhance student engagement and comprehension.
                  </p>
                  <p className="text-muted-foreground">
                    In this course, you'll benefit from Dr. Johnson's extensive knowledge of fairy tales and folklore, delivered through her engaging lecture style and supplemented by her custom-designed AI tutor that provides personalized guidance throughout your learning journey.
                  </p>
                </div>
              </div>
            )}
